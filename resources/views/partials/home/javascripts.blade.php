...
<script src="{{JS_HOME_ONLINE}}modernizr.min.js"></script>

<!-- <script src='https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js'></script> -->

<script src="{{JS_HOME_ONLINE}}js-offcanvas.pkgd.min.js"></script>

<!-- <script src='https://npmcdn.com/js-offcanvas@1.0/dist/_js/js-offcanvas.pkgd.min.js'></script> -->

<script src="{{JS_HOME}}slider/owl.carousel.min.js"></script>
...
<script src="{{JS_HOME}}dashboard.js"></script>

<script src="{{JS}}sweetalert-dev.js"></script>


<script src="{{JS_HOME}}datatables.min.js"></script>
<script src="{{asset('public/country_codes/js/intlTelInput.js')}}"></script>
