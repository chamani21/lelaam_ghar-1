...
Route::get('users/subscription/create', 'Admin\UsersController@showSubscriptionForm')->name('users.subscription');
Route::post('users/{id}/subscription/{type}', 'Admin\UsersController@updateSubscription');
...
Route::any('mastersettings/settings/getList', [
