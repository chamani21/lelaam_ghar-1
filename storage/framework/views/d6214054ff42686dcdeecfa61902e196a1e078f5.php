            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 au-deals">
                    ...
                    <h2 class="text-center"> 
                        <?php echo e(getPhrase('fixed_price_sale')); ?> 
                    </h2> </div>
            </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-12 col-md-12 col-sm-12 au-all-upcoming">
                   <div class="text-center">
                    <a href="<?php echo e(URL_HOME_AUCTIONS); ?>" class="btn btn-primary au-space au-btn-gray login-bttn view-more-btn view-more-btn-animation-1"><?php echo e(getPhrase('view_all_buy_now_sales')); ?></a>
                       </div>
                </div>
            </div>
