            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 au-deals">
                    ...
                    <h2 class="text-center"> 
                        <?php echo e(getPhrase('upcoming_auctions')); ?> 
                    </h2> </div>
            </div>
            ...
            <div class="row au-line-bottom bar-line">
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-6 ">
                    <div class="au-bidding">
                        <a href="<?php echo e(URL_HOME_AUCTION_DETAILS); ?>/<?php echo e($auction->slug); ?>" title="Auction Details" class="btn btn-default au-space au-btn-gray login-bttn view-more-btn view-more-btn-animation-1"><?php echo e(getPhrase('view_details')); ?></a>
            ...
            <div class="row mt-4">
                <div class="col-lg-12 col-md-12 col-sm-12 au-all-upcoming">
                   <div class="text-center">
                    <a href="<?php echo e(URL_HOME_AUCTIONS); ?>" class="btn btn-primary au-space au-btn-gray login-bttn view-more-btn view-more-btn-animation-1"><?php echo e(getPhrase('view_all_upcoming_auctions')); ?></a>
                       </div>
                </div>
            </div>
