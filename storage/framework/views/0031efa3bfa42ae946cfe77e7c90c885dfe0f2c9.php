        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 au-sub-footer">
                    <p class="text-center"> <?php echo e(getSetting('rights_reserved','site_settings')); ?> <?php echo $__env->make('mastersettings.settings.file', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> </p>
                </div>
            </div>
            <!--footer body section-->
        </div>
